...
namespace ITSharp.DBExtractor
{
    ...
    {
        private static readonly string WorkingDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), "DBExtractor");
        ...
        public DBExtractorService()
        {
            ...
            //if(register != null)
            //    this.workingDir = Path.Combine(register.GetValue("UserWorkingDirectory").ToString(), "DBExtractor");

            //this.eventsFilePath = Path.Combine(this.workingDir, @"events.bin");

            //WorkingDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), @"DBExtractor");
            //EventsFileName = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), @"DBExtractor\events.bin"); 
